...
export const COURSES = {
  ...
  intermediate: {
    ...
    descAr: 'أسرار البحث عن المنتجات والموردين والبيع الاحترافي — 50 درساً',
    descEn: 'Product research, suppliers, and professional selling secrets — 50 lessons',
  ...
  basic: {
    ...
    descAr: 'أساسيات eBay وإعداد الحساب والبداية الصحيحة — 25 درساً',
    descEn: 'eBay fundamentals, account setup, and the right start — 25 lessons',
