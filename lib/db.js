...
const CDN = 'https://cdn.coachbasharalasali.com'

export const COURSES = {
  elite: {
    id: 'elite',
    nameAr: 'الباقة الكاملة — Elite',
  ...
  professional: {
    id: 'professional',
    nameAr: 'الباقة المتوسطة — Professional',
  ...
  starter: {
    id: 'starter',
    nameAr: 'باقة التنفيذ — Starter',
    nameEn: 'Starter Package',
    descAr: 'دورة متكاملة من الدرس الأول حتى الدرس 75 مع رسالة الختام — 76 درساً (6 ساعات دعم)',
    descEn: 'Complete course from lesson 1 to 75 plus closing message — 76 lessons (6 hours support)',
    lessons: [...Array.from({ length: 75 }, (_, i) => i + 1), 86],
    hours: 6,
    icon: '🚀'
  }
...
export const QUIZZES = {
  5: {
    questions: [
      {
        q: "ما هي أفضل خطوات النجاح على موقع eBay؟",
        qEn: "What are the best steps for success on eBay?",
        opts: ["فتح الحسابات", "العرض والتنزيل", "بحث الموردين", "جميع ما ذكر"],
        optsEn: ["Opening accounts", "Listing and uploading", "Supplier research", "All of the above"],
        correct: 3
      }
    ]
  },
  6: {
    questions: [
      {
        q: "ما هو الدروب شيبينج؟",
        qEn: "What is dropshipping?",
        opts: ["بيع المنتجات التي نملكها", "التسويق للمنتجات التي نملكها", "شراء المنتجات وتخزينها قبل بيعها", "بيع المنتجات التي لا نملكها ولا نخزنها"],
        optsEn: ["Selling products we own", "Marketing products we own", "Buying and storing products before selling", "Selling products we don't own or store"],
        correct: 3
      },
      {
        q: "من هو المورد في نظام الدروب شيبينغ؟",
        qEn: "Who is the supplier in the dropshipping system?",
        opts: ["البريد", "المخزون لدينا", "المورد الخارجي الذي يشحن المنتج مباشرة إلى العميل بدون أن تقوم أنت بتخزين المنتج", "المورد بالأردن"],
        optsEn: ["The post office", "Our own inventory", "The external supplier who ships directly to the customer without you storing the product", "The supplier in Jordan"],
        correct: 2
      }
    ]
  },
  8: {
    questions: [
      {
        q: "ما معنى كلمة دروب شيبر؟",
        qEn: "What does the word 'drop shipper' mean?",
        opts: ["رقم تتبع", "شخص يعمل بنظام الدروب شيبينغ ويبيع المنتجات التي يملكها", "شخص يعمل بنظام الدروب شيبينغ ويبيع المنتجات التي لا يملكها ولا يخزنها", "قضايا مفتوحة علينا"],
        optsEn: ["A tracking number", "A person who sells products they own via dropshipping", "A person who sells products they don't own or store via dropshipping", "Open cases against us"],
        correct: 2
      },
      {
        q: "ما هو Seller Hub؟",
        qEn: "What is Seller Hub?",
        opts: ["خيارات المنتج", "المنتجات المعروضة", "مركز تحكم بالمتجر على eBay", "تقييمنا على eBay"],
        optsEn: ["Product options", "Listed products", "Store control center on eBay", "Our rating on eBay"],
        correct: 2
      }
    ]
  },
  9: {
    questions: [
      {
        q: "ما هو موقع AliExpress؟",
        qEn: "What is AliExpress?",
        opts: ["موقع منتجات أمريكي", "موقع منتجات بريطاني", "مورد خاص بنظام الدروب شيبينغ في أمريكا", "موقع خاص بالمنتجات والموردين والمصانع الموجودة في الصين ويُستخدم في الدروب شيبينغ"],
        optsEn: ["An American products website", "A British products website", "A dropshipping supplier for the US market", "A website for Chinese products, suppliers, and factories used in dropshipping"],
        correct: 3
      }
    ]
  },
  12: {
    questions: [
      {
        q: "ما هو الـ Suspended الذي لا يمكن فكه على eBay؟",
        qEn: "Which type of suspension cannot be reversed on eBay?",
        opts: ["Suspended MC011", "Suspended Triple 999", "Suspended للأبد", "Suspended أولي"],
        optsEn: ["Suspended MC011", "Suspended Triple 999", "Permanently Suspended", "Initial Suspension"],
        correct: 2
      }
    ]
  },
  21: {
    questions: [
      {
        q: "ما هي الوثيقة البنكية التي يحتاجها حساب Payoneer للتوثيق؟",
        qEn: "What bank document does a Payoneer account need for verification?",
        opts: ["كشف حساب بنك لآخر 6 أشهر مثبت فيه اسمك وعنوان السكن", "كشف بطاقة بنكية مثبت فيها الاسم أو عنوان السكن", "فاتورة كهرباء أو ماء ليست باسمك", "A فقط"],
        optsEn: ["Bank statement for the last 6 months showing your name and home address", "Bank card statement showing name or home address", "Electricity or water bill not in your name", "A only"],
        correct: 3
      }
    ]
  },
  32: {
    questions: [
      {
        q: "متى يتم استخدام سياسة الشحن إلى البيت؟",
        qEn: "When is the home shipping policy used?",
        opts: ["عند بيع أول منتج لدينا", "عند بدء بيع منتجات الدروب شيبينغ", "عند بيع المنتجات الموجودة لدينا ومنتجات الدروب شيبينغ", "جميع ما ذكر"],
        optsEn: ["When selling our first product", "When starting to sell dropshipping products", "When selling both our own and dropshipping products", "All of the above"],
        correct: 0
      }
    ]
  }
