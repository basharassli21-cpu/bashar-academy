...
import { TwoFactorSetupDialog } from "@/components/admin/security/two-factor-setup-dialog";
import { BackupCodesDialog } from "@/components/admin/security/backup-codes-dialog";
import { DisableTwoFactorDialog } from "@/components/admin/security/disable-two-factor-dialog";
import { ChangePasswordCard } from "@/components/admin/security/change-password-card";

export function AdminSecurityPageClient({ initialTotpEnabled }: { initialTotpEnabled: boolean }) {
